    ...
    <section className='HomePage' style={{display:homedisplay}}>
      <div className="inputfield">
        ...
        <div className='frominput'>
          ...
          <input type="text" id='from' value={from} onChange={(e) => setFrom(e.target.value)} placeholder='Enter From Station' onClick={HandleOnChangeFrom} />
        </div>
        ...
        <div className='toinput'>
         ...
         <input type="text" id='to' value={to} onChange={(e) => setTo(e.target.value)} placeholder='Enter To station' onClick={HandleOnChangeTo} />
        </div>
